                  ...
                  {this.props.search.searchText !=='' &&
                      <View>
                        ...
                        {/*
                          <View style={SearchStyles.gameListBox}>
                          <View style={SearchStyles.transformView}>
                            <Icon name={category.categoryIcon.slice(6)} size={ Globals.DeviceType === 'Phone'? 22 : 40 } style={SearchStyles.iconStyle} color='#423620' />
                          ...
                          <View style={SearchStyles.viewAllStyle} />
                          <View style={SearchStyles.viewAllViewStyle}>
                            <TouchableOpacity onPress={() => this.viewCategoryGames(category) }>
                              <Text style={[styles.avRegular, SearchStyles.browseAll]}>
                                  VIEW ALL
                              </Text>
                            </TouchableOpacity>
                          </View>

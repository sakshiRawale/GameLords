...
class GameView extends Component {
    ...
    render() {
        ...
        return (
            <View style={[WelcomeStyle.imageThmbnailGames,this.props.for === 'favoriteCategory' ? WelcomeStyle.setPaddingFavorite : WelcomeStyle.setPaddingSlider]} key={gameIndex}>
              <View style={{flex: 3}}>
